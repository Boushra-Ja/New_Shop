...
import 'package:new_shop/models/Boshra/Store/NameModel.dart';
class ReportPageController extends GetxController{
  ...
  String? validate_content(var val)
  {
    if(val == '')
      ...
      return "محتوى الشكوى يجب أن يكون أكبر من 30 محرف";
  ...
  Future<void> fetch_shops()async{
    ...
    final response = await http.get(Uri.parse('${MyApp.api}/api/shop_names')) ;
