...
class Product {
  ...
  var id , product_name , discription  ,image  , selling_price  ,num_cell ,
      ...
      salling_store , similar_product , discount_id , discount_value;
  int review =  0;
  ...
  factory Product.fromJson(Map<String , dynamic> json)
  {
    ...
    return Product(id : json['product_id'] ,product_name: json['product_name'],discription: json['discription'],image: json['image']
        ...
        store_name : json['store_name'], salling_store:json['num_salling_store'] , discount_id:json['discount_id'] , discount_value: json['discount_value']
        );
  }
  ...
  Product({required this.id , required this.product_name,required this.discription, required this.image,  required this.selling_price,
    required this.num_cell , required this.prepration_time, required this.return_or_replace ,required this.store_id , required this.store_name ,required this.salling_store , required this.all_review ,  this.similar_product , required this.discount_id ,required this.discount_value});
