...
import 'package:new_shop/logic/controllers/orders/OrderDetailController.dart';
import '../../main.dart';
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    controller.selected_options[controller.order_products.elementAt(index).order_product_id]?.length != null ? ListView.builder(
                                        shrinkWrap: true ,
                                        physics: NeverScrollableScrollPhysics(),
                ...
                return  Center(
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 20,),
                      Text("لا يوجد طلبات متوفرة حالياً" ,)
                    ],
                  ),
                );
              })
