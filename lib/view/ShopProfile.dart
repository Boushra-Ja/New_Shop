...
class ShopState extends State<ShopProfile> {
  bool check_tap = true;

  @override
  Widget build(BuildContext context) {
    const color = const Color(0xFFAF3A88);
    String dropdownvalue = 'خياطة';
    var items = [
      'خياطة',
      'اكسسوارات',
      'مواد تجميل',
                    ...
                    children: [
                        ...
                        child: SizedBox(
                          ...
                          child: Column(
                            children: [
                              ...
                              Divider(
                                thickness: check_tap ? 3 : 1,
                                color: check_tap ? color : Colors.grey.shade200,
                              )
                            ],
                          ),
                        ),
                      ...
                      InkWell(
                        ...
                        child: SizedBox(
                          ...
                          child: Column(
                            children: [
                              Text("التقييمات", textAlign: TextAlign.center),
                              Divider(
                                thickness: check_tap == false ? 3 : 1,
                                color: check_tap == false
                                    ? color
...
class HeaderCurvedContainer extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Paint paint = Paint()
      ..shader = ui.Gradient.linear(const Offset(10, 100),
          const Offset(450, 100), [color, color]);
    Path path = Path()
